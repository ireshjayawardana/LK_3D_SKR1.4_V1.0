...
#define CUSTOM_MACHINE_NAME "3D iresh1"
...
#define DELTA
  ...
  //   #define DELTA_CARRIAGE_OFFSET 60.6    // (mm)
  ...
  // #define DELTA_DIAGONAL_ROD 270        // (mm)
  //   // Horizontal offset from middle of printer to smooth rod center.
  // #define DELTA_SMOOTH_ROD_OFFSET 179   // (mm)
  // // Horizontal offset of the universal joints on the end effector.
...
// Distance between bed and nozzle Z home position
#define DELTA_HEIGHT 880.00             // (mm) Get this value from G33 auto calibrate
 ...
 */
 ...
 #define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 208.33 }
/**
 ...
 */
//#define Z_MIN_PROBE_PIN Z_DIAG_PIN // Pin 32 is the RAMPS default
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   10 // Z Clearance for Deploy/Stow 50
#define Z_CLEARANCE_BETWEEN_PROBES  5 // Z Clearance between probe points 15
#define Z_CLEARANCE_MULTI_PROBE     5 // Z Clearance between multiple probes 5 
...
//#define Z_MAX_POS DELTA_HEIGHT - 10
